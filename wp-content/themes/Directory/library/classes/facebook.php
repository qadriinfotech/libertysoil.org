...
class supreme_facebook extends WP_Widget {
	function supreme_facebook() {
		//Constructor
		$widget_ops = array('classname' => 'widget Templatic facebook fans t_facebook_fans', 'description' => __('Display a like box for your Facebook page. Works best in sidebar areas.',ADMINDOMAIN) );

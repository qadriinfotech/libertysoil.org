...
<p>
  <label for="supreme-document-title">
    <?php echo __( 'Document Title', ADMINDOMAIN ); echo ": "; ?>
  </label>
  <br />
...
<p>
  <label for="supreme-meta-description">
    <?php echo __( 'Meta Description', ADMINDOMAIN ); echo ": "; ?>
  </label>
  <br />
...
<p>
  <label for="supreme-meta-keywords">
    <?php echo __( 'Meta Keywords', ADMINDOMAIN ); echo ": "; ?>
  </label>
  <br />

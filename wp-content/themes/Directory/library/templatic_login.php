...
function tmpl_get_remote_verison(){
	...
	{ 
		...
		{		
			...
			{
				$warnning_message="Update was unable to continue because ".$th_name." theme doesn't seem to be associated with your Templatic account. Please <a href='http://templatic.com/contact/' target='_blank'>contact us</a> if this message is showing in error.";
			}			
...
<div class='wrap templatic_login'>
  ...
  <?php } ?>
  <!-- Logo -->
  <div id='pblogo'> <a href="http://templatic.com" alt="WordPress Directory Theme" title="WordPress Directory Theme"><img src="<?php echo esc_url( get_template_directory_uri()."/images/templatic-wordpress-themes.jpg"); ?>" alt="WordPress Directory Theme" style="margin-right: 50px;" /></a><?php echo '<h3>'. @$theme_name.' Updates</h3>'; ?> </div>
  <?php
		if($flag ==1){

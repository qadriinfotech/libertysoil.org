	...
	{		
		//check the remote version
		 ...
		 {	
			...
			echo '<tr class="plugin-update-tr"><td colspan="3" class="plugin-update"><div class="update-message">' . $new_version . __( ' <a href="'.$ajax_url.'" class="thickbox" title="Templatic Location Manager Update">update now</a>.', LMADMINDOMAIN) .'</div></td></tr>';
